    ...
    <div class="container">
        ...
        <div class="need--list">
            <div class="need--item">
                ...
                <div class="content">По прибытию на место автоэлектрик проведет полноценную диагностику вашего автомобиля, с целью выявления причины неисправности.</div>
            </div>
            <div class="need--item">
                <div class="number">02</div>
                <div class="content">Использование современного оборудования, позволит минимизировать время проведения полноценного исследования работы всех электрических компонентов авто.</div>
            </div>
            <div class="need--item">
                <div class="number">03</div>
                <div class="content">Будет проведена проверка исправности работы генератора, основных агрегатов, аккумулятора, кондиционера, целостность электрических цепей и датчиков.</div>
            </div>
        </div>
    </div>
</section>
...
<section class="s-section section-grey section--auto" data-section="auto-section">
    <div class="container">
        <h2>автомобили</h2>
        <div class="auto--description">Наши мастера – автотехники, оборудованы нужным инструментом и дилерским оборудованием для всех марок автомобилей</div>
        <div class="auto--wrap">
